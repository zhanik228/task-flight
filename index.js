...
const departureProbabilityDisplay = document.getElementById('departure-probability-display')
...
departureDateInput.addEventListener('change', () => {
    ...
    if (flight) {
        ...
        const departureProbability = calculateDepartureProbability(flight.passengersBooked, 60)
